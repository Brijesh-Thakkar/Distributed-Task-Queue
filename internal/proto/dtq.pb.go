...
func (*TaskMessage) Descriptor() ([]byte, []int) {
	return file_dtq_proto_rawDescGZIP(), []int{0}
}
...
func (*ServerInfo) Descriptor() ([]byte, []int) {
	return file_dtq_proto_rawDescGZIP(), []int{1}
}
...
func (*WorkerInfo) Descriptor() ([]byte, []int) {
	return file_dtq_proto_rawDescGZIP(), []int{2}
}
...
func (*SchedulerEntry) Descriptor() ([]byte, []int) {
	return file_dtq_proto_rawDescGZIP(), []int{3}
}
...
func (*SchedulerEnqueueEvent) Descriptor() ([]byte, []int) {
	return file_dtq_proto_rawDescGZIP(), []int{4}
}
...
var File_dtq_proto protoreflect.FileDescriptor

const file_dtq_proto_rawDesc = "" +
	"\n" +
	"\tdtq.proto\x12\x03dtq\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfc\x03\n" +
	"\vTaskMessage\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x18\n" +
	"\apayload\x18\x02 \x01(\fR\apayload\x127\n" +
	"\aheaders\x18\x0f \x03(\v2\x1d.dtq.TaskMessage.HeadersEntryR\aheaders\x12\x0e\n" +
	...
	"\vconcurrency\x18\x04 \x01(\x05R\vconcurrency\x123\n" +
	"\x06queues\x18\x05 \x03(\v2\x1b.dtq.ServerInfo.QueuesEntryR\x06queues\x12'\n" +
	...
	"\fenqueue_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\venqueueTimeBBZ@github.com/brijesh-thakkar/distributed-task-queue/internal/protob\x06proto3"

var (
	file_dtq_proto_rawDescOnce sync.Once
	file_dtq_proto_rawDescData []byte
)

func file_dtq_proto_rawDescGZIP() []byte {
	file_dtq_proto_rawDescOnce.Do(func() {
		file_dtq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dtq_proto_rawDesc), len(file_dtq_proto_rawDesc)))
	})
	return file_dtq_proto_rawDescData
}

var file_dtq_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_dtq_proto_goTypes = []any{
	(*TaskMessage)(nil),           // 0: dtq.TaskMessage
	(*ServerInfo)(nil),            // 1: dtq.ServerInfo
	(*WorkerInfo)(nil),            // 2: dtq.WorkerInfo
	(*SchedulerEntry)(nil),        // 3: dtq.SchedulerEntry
	(*SchedulerEnqueueEvent)(nil), // 4: dtq.SchedulerEnqueueEvent
	nil,                           // 5: dtq.TaskMessage.HeadersEntry
	nil,                           // 6: dtq.ServerInfo.QueuesEntry
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_dtq_proto_depIdxs = []int32{
	5, // 0: dtq.TaskMessage.headers:type_name -> dtq.TaskMessage.HeadersEntry
	6, // 1: dtq.ServerInfo.queues:type_name -> dtq.ServerInfo.QueuesEntry
	7, // 2: dtq.ServerInfo.start_time:type_name -> google.protobuf.Timestamp
	7, // 3: dtq.WorkerInfo.start_time:type_name -> google.protobuf.Timestamp
	7, // 4: dtq.WorkerInfo.deadline:type_name -> google.protobuf.Timestamp
	7, // 5: dtq.SchedulerEntry.next_enqueue_time:type_name -> google.protobuf.Timestamp
	7, // 6: dtq.SchedulerEntry.prev_enqueue_time:type_name -> google.protobuf.Timestamp
	7, // 7: dtq.SchedulerEnqueueEvent.enqueue_time:type_name -> google.protobuf.Timestamp
...
func init() { file_dtq_proto_init() }
func file_dtq_proto_init() {
	if File_dtq_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dtq_proto_rawDesc), len(file_dtq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dtq_proto_goTypes,
		DependencyIndexes: file_dtq_proto_depIdxs,
		MessageInfos:      file_dtq_proto_msgTypes,
	}.Build()
	File_dtq_proto = out.File
	file_dtq_proto_goTypes = nil
	file_dtq_proto_depIdxs = nil
}
