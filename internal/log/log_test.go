	...
	tests := []tester{
		{
			...
			message: "hello, world!",
			wantPattern: fmt.Sprintf("^dtq: pid=%s %s %s%s DEBUG: hello, world!\n$",
	...
	tests := []tester{
		{
			desc:    "without trailing newline, logger adds newline",
			message: "hello, world!",
			wantPattern: fmt.Sprintf("^dtq: pid=%s %s %s%s INFO: hello, world!\n$",
				rgxPID, rgxdate, rgxtime, rgxmicroseconds),
		},
		{
			desc:    "with trailing newline, logger preserves newline",
	...
	tests := []tester{
		{
			desc:    "without trailing newline, logger adds newline",
			message: "hello, world!",
			wantPattern: fmt.Sprintf("^dtq: pid=%s %s %s%s WARN: hello, world!\n$",
				rgxPID, rgxdate, rgxtime, rgxmicroseconds),
		},
		{
			desc:    "with trailing newline, logger preserves newline",
	...
	tests := []tester{
		{
			desc:    "without trailing newline, logger adds newline",
			message: "hello, world!",
			wantPattern: fmt.Sprintf("^dtq: pid=%s %s %s%s ERROR: hello, world!\n$",
				rgxPID, rgxdate, rgxtime, rgxmicroseconds),
		},
		{
			desc:    "with trailing newline, logger preserves newline",
	...
	tests := []formatTester{
		{
			...
			wantPattern: fmt.Sprintf("^dtq: pid=%s %s %s%s DEBUG: hello, Gopher!\n$",
				rgxPID, rgxdate, rgxtime, rgxmicroseconds),
		},
	}
	...
	tests := []formatTester{
		{
			...
			wantPattern: fmt.Sprintf("^dtq: pid=%s %s %s%s INFO: 1,2,3\n$",
				rgxPID, rgxdate, rgxtime, rgxmicroseconds),
		},
	}
	...
	tests := []formatTester{
		{
			...
			wantPattern: fmt.Sprintf("^dtq: pid=%s %s %s%s WARN: hello, Gophers\n$",
				rgxPID, rgxdate, rgxtime, rgxmicroseconds),
		},
	}
	...
	tests := []formatTester{
		{
			...
			format: "hello, %s",
			args:   []interface{}{"Gophers"},
			wantPattern: fmt.Sprintf("^dtq: pid=%s %s %s%s ERROR: hello, Gophers\n$",
				rgxPID, rgxdate, rgxtime, rgxmicroseconds),
		},
	}
